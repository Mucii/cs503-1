...
/* in file get_faults.c */
extern	uint32 get_faults();
...
/* in file read_bs.c */
extern	syscall	read_bs(char *, bsd_t, uint32);
...
/* in file write_bs.c */
extern	syscall	write_bs(char *, bsd_t, uint32);
