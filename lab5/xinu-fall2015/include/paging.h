...
#ifndef NFRAMES 
#define NFRAMES		3072	/* number of frames 3072 */ 
#endif
...
/****************** page tables related definition *************************/

extern pt_t *globalpt[4]; 
int globalptinit();
pd_t * getpdir(); 
int freepdir(pd_t *pd); pt_t * getptable(); int freeptable(pt_t *pt);
...
/* data structure for the backing store map */
...
/* data structure for passing bsid and offset */
